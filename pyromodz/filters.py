...
from pyromodz.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyromodz.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyromodz.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyromodz.handlers.MessageHandler` the *update* argument will be a :obj:`~pyromodz.types.Message`; in a :obj:`~pyromodz.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyromodz.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyromodz.filters.command` or :meth:`~pyromodz.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyromodz.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyromodz.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyromodz.types.Message`.
    ...
    async def func(flt, client: pyromodz.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyromodz.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyromodz.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyromodz.types.InlineQuery`: The filter will match ``query``.
