...
class Object:
    def __init__(self, client: "pyromodz.Client" = None):
        self._client = client

    def bind(self, client: "pyromodz.Client"):
        """Bind a Client instance to this and to all nested Pyromodz objects.

        Parameters:
            client (:obj:`~pyromodz.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Pyromodz objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/pyromodzchat/167281
