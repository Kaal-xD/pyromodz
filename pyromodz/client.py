...
import pyromodz
from pyromodz import __version__, __license__
from pyromodz import enums
from pyromodz import raw
from pyromodz import utils
from pyromodz.crypto import aes
from pyromodz.errors import CDNFileHashMismatch
from pyromodz.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pyromodz.handlers.handler import Handler
from pyromodz.methods import Methods
from pyromodz.session import Auth, Session
from pyromodz.storage import FileStorage, MemoryStorage
from pyromodz.types import User, TermsOfService
from pyromodz.utils import ainput
...
class Client(Methods):
    """Pyromodz Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyromodz.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Pyromodz will store the session files.
    ...
    APP_VERSION = f"Pyromodz {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Pyromodz (version {__version__})")
        print(f"Pyromodz is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyromodz.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.pyromodz.org/start/auth")
