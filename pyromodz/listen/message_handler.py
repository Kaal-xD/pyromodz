...
from ..handlers.message_handler import (
    MessageHandler as PyroMessageHandler)
from ..types import Message
from ..types.identifier import Identifier
from ..types.listener_types import ListenerTypes
from ..types.messages_and_media.message import Message
from ..utilities import should_patch, patch_into



@patch_into(PyroMessageHandler)
class MessageHandler(PyroMessageHandler):
    filters: Filter
