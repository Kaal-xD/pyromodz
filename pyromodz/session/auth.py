...
from pyromodz.connection import Connection
from pyromodz.crypto import aes, rsa, prime
from pyromodz.errors import SecurityCheckMismatch
from pyromodz.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyromodz.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
