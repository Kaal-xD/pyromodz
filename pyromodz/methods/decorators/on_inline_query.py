...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~pyromodz.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.InlineQueryHandler(func, self),
