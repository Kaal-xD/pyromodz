...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~pyromodz.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.ChatMemberUpdatedHandler(func, self),
