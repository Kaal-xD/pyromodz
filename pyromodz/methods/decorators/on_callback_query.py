...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~pyromodz.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.CallbackQueryHandler(func, self),
