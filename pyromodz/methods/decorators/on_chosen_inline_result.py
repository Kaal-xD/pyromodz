...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pyromodz.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.ChosenInlineResultHandler(func, self),
