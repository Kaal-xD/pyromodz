...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~pyromodz.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.UserStatusHandler(func, self),
