...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~pyromodz.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.DeletedMessagesHandler(func, self),
