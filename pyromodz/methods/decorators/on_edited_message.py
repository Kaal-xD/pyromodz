...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pyromodz.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyromodz.Client):
                self.add_handler(pyromodz.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyromodz.handlers.EditedMessageHandler(func, self),
