...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyromodz.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyromodz.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
