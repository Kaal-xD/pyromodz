...
import pyromodz
from pyromodz import StopTransmission, enums
...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~pyromodz.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyromodz.Client.stop_transmission`, None is
            returned.
