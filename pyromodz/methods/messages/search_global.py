...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyromodz.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyromodz.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyromodz.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyromodz". Get the first 50 results
                async for message in app.search_global("pyromodz", limit=50):
                    print(message.text)
