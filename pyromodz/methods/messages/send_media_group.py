...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyromodz.types.InputMediaPhoto`, :obj:`~pyromodz.types.InputMediaVideo`, :obj:`~pyromodz.types.InputMediaAudio` and :obj:`~pyromodz.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyromodz.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyromodz.types import InputMediaPhoto, InputMediaVideo
