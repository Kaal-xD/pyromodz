...
import pyromodz
from pyromodz import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~pyromodz.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **Pyromodz**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.pyromodz.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.pyromodz.org")]
                        ]))
        """
