...
from pyromodz.errors import AuthBytesInvalid
from pyromodz.session import Session
from pyromodz.session.auth import Auth


async def get_session(client: "pyromodz.Client", dc_id: int):
